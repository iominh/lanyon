...
---
This post will describe why I switched to Google Code Prettify after using Highlight.js and SyntaxHighlighter.

<!--break-->

This time I've decided to use [Google-Code-Prettify](https://code.google.com/p/google-code-prettify/).
